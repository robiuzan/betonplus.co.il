...
//
// Why this exists: WordPress themes often render pages from server-side post-meta that the
// REST API does NOT expose (content.rendered comes back empty). When that's the case, page
