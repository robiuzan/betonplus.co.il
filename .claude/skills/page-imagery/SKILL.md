...
| ----------------------- | ------------------------------------------------------------------ | ------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Home hero visual**    | `components/Hero.tsx:58` — the `hidden lg:block` card              | ~482px (`lg:grid-cols-[1.1fr_0.9fr]`) | 4:3 or 1:1           | **Desktop only.** Hidden below `lg`, so a photo here is never the mobile LCP. Today it is an icon-and-stats card; replacing it is a layout decision, not just an art one. |
