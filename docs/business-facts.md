...
| Item                             | State                                                                                                                                                                                                                                                                                       |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GTM container                    | ✅ `GTM-KWGGH438` — verified 200, live in production, **version 5** (2026-09-16). Shared across the Israeli fleet; GA4 is resolved inside it by a hostname lookup.                                                                                                                          |
| GA4 property for betonplus.co.il | ✅ `G-VMVP7XQKMG` — in the roster, synced to `site.config.json`, routed by hostname. **Lead events tagged 2026-09-16** (container v5); `page_view` and `cta_click` confirmed in DebugView. GA4-side settings (key events, custom dimensions, Search Console link) still open — roadmap 7.8. |
